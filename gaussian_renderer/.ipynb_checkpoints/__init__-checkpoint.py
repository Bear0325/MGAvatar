...
# def render(viewpoint_camera, gaussian_assets, sh_degree, pipe, bg_color : torch.Tensor, scaling_modifier = 1.0, override_color = None):
#     """
#     Render the scene. 
...
#     shs = gaussian_assets['shs']   # 颜色 (N, 3) - RGB值
...
#             "radii": radii}
def render(viewpoint_camera, pc : Union[GaussianModel, FlameGaussianModel], pipe, bg_color : torch.Tensor, gaussian_assets = None, scaling_modifier = 1.0, override_color = None):
    """
    Render the scene. 
