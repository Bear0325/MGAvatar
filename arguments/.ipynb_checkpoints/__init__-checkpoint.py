...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.iteration_stage1 = 100000 #120000 #80000 #第一轮次数
        self.iteration_stage2 = 0 #240000 
        ...
        self.densification_interval = 1000 #2_000  # 100 (original)
        self.opacity_reset_interval = 30000 #60_000 # 3000 (original)
        self.densify_from_iter = 5_000  # 500 (original)
        self.densify_until_iter = 150_000  # 15_000 (original)
