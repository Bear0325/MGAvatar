...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.iteration_stage1 = 100000  #第一轮次数
        self.iteration_stage2 = 240000 #240000 
        self.lr = 1e-3 #5e-3#1e-3 
        ...
        self.position_lr_max_steps = 240000 #600_000  # 30_000 (original)
        self.feature_lr = 0.0025
        # self.net_lr = 0.01
        # self.net_lr_step = [50000, 150000, 250000]
        self.net_lr = 0.01
        self.net_lr_step = [30000, 80000, 150000]

        # DualBranchUnet
        self.dual_branch_lr = 1e-4
        self.lambda_offset_scale_reg = 1e-2
        self.lambda_offset_color_reg = 1e-3

        self.opacity_lr = 0.05
        self.scaling_lr = 0.017  # (scaled up according to mean triangle scale)  # 0.005 (original)
        self.rotation_lr = 0.001
        self.densification_interval = 1000 
        self.opacity_reset_interval = 9999999999 #30000 
